...
[![PyPI version](https://badge.fury.io/py/py-audit.svg)](https://pypi.org/project/py-audit/)
...
result = audit("Hello World")

# Example 2: Batch processing
from py_audit import batch
